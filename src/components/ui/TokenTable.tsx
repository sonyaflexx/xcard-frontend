            ...
            <div className="container mx-auto flex-1">
                <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-400 max-h-[450px]">
                    <table className="min-w-full text-xs">
                        <thead className="relative top-0 bg-gray-200 dark:bg-gray-500">
                            <div className="absolute flex items-center gap-2 font-semibold text-lg top-4 left-5">
                            ...
                            <tr className="top-0 text-gray-300 font-semibold text-xs">
