...
export default function NavList({ activePage }: { activePage: string }) {
    return (
        <div className="flex flex-col h-full">
            ...
            <NavItem href="/menu" className="mt-auto self-end">
                <svg
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
